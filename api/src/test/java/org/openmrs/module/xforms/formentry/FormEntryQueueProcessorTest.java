...
public class FormEntryQueueProcessorTest extends BaseModuleContextSensitiveTest {
	...
	public void transformFormEntryQueue_shouldTransformXmlDataWithASerializedComplexObs() throws Exception {
		...
		try {
			...
			HL7InQueue hl7inQueue = new FormEntryQueueProcessor().transformFormEntryQueue(formEntryQueue, false);
	...
	//TODO Uncomment
	/*
	private class NeighborObsHandler implements SerializableComplexObsHandler {
