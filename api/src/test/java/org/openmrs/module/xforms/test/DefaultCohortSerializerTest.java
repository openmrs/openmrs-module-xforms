...
public class DefaultCohortSerializerTest extends BaseModuleContextSensitiveTest{
    ...
    public void testSerialize() throws Exception {
        ...
        Assert.assertTrue("The first cohort name should be: The First Unit Test Cohort", name.equals("The First Unit Test Cohort"));
        
        id = dis.readInt();
        Assert.assertTrue("The second cohort_id should be 2", id == 2);
        
        name = dis.readUTF();
        Assert.assertTrue("The second cohort name should be: The Second Unit Test Cohort", name.equals("The Second Unit Test Cohort"));
    }
}
