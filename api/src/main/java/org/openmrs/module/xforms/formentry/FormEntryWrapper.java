...
public class FormEntryWrapper {
	...
	/**
	 * Replaces %Y in the string with the four digit year. Replaces %M with the two digit month Replaces
	 * %D with the two digit day Replaces %w with week of the year Replaces %W with week of the month
	 * 
	...
	public static String getFormSchemaNamespace(Form form) {
		String serverURL = Context.getAdministrationService().getGlobalProperty(FORMENTRY_GP_SERVER_URL,
		    FORMENTRY_GP_SERVER_URL + " cannot be empty");
