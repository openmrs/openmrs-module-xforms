...
/**
 * This class contains utilities used during the translation of xforms and form layout in various
 * locales.
 * 
 * @author daniel
 */
public class LanguageUtil {
	 ...
	 * @return the new document xml after its text has been replaced with that from the language
	 *         document.
	 */
	...
	public static String translate(Document doc, Element parentLangNode) {
		...
		for (int index = 0; index < nodes.getLength(); index++) {
			...
			if (result != null) {
				...
				if (result.size() > 2) {
					System.out.println(
					    "xforms module error: " + result.size() + "..........." + xpath + "............" + value);
					continue;
