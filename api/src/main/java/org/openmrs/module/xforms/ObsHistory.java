...
/**
 * Retrieves observations, for a given patient, as used in form field default value velocity
 * templates.
 * 
 * @author danielkayiwa
 */
public class ObsHistory {
	 ...
	 * 
	 * @param encounterIndex is the index of the observation starting with 1 for the most recent, 2 for
	 *            the second most recent, 3 for the third most recent, and more.
	 * @param conceptId is the concept id.
	 * @return an {@link Obs} object.
	 */
	public Obs getObs(int encounterIndex, int conceptId) {
		...
		List<Obs> observations = Context.getObsService().getObservations(whom, null, questions, null, null, null, sort, null,
