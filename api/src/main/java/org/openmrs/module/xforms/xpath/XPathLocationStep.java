...
public class XPathLocationStep implements Serializable {
	...
	/**
	 * the contextNodeSet is made of nodes that are instances of Element A fix is needed here: to the
	 * result vector I only add Element-s or String. This is not correct. I should only add Node-s
	 */
