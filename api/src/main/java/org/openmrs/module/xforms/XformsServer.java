...
/**
 * Serves xform services to non HTTP connections. Examples of such connections can be SMS,
 * Bluetooth, Data cable, etc.
 * 
 * @author Daniel
 */
public class XformsServer {
	...
	/**
	 * Called when a new connection has been received. Failures are not handled in this class as
	 * different servers (BT,SMS, etc) may want to handle them differently.
	 * 
	 * @param dis - the stream to read from.
	 * @param dos - the stream to write to.
	 */
	public void processConnection(DataInputStream dis, DataOutputStream dosParam) throws IOException, Exception {
