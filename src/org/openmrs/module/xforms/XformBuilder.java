...
public final class XformBuilder {
    ...
    public static String getNewPatientXform(){			
        ...
        addPatientNode(formNode,modelNode,xformsNode,NODE_FAMILY_NAME,DATA_TYPE_TEXT,"Family Name","The patient family name",true,false,CONTROL_INPUT,null,null);
        addPatientNode(formNode,modelNode,xformsNode,NODE_MIDDLE_NAME,DATA_TYPE_TEXT,"Middle Name","The patient middle name",false,false,CONTROL_INPUT,null,null);
        addPatientNode(formNode,modelNode,xformsNode,NODE_GIVEN_NAME,DATA_TYPE_TEXT,"Given Name","The patient given name",false,false,CONTROL_INPUT,null,null);
        addPatientNode(formNode,modelNode,xformsNode,NODE_BIRTH_DATE,DATA_TYPE_DATE,"Birth Date","The patient birth date",false,false,CONTROL_INPUT,null,null);
        addPatientNode(formNode,modelNode,xformsNode,NODE_IDENTIFIER,DATA_TYPE_TEXT,"Identifier","The patient identifier",true,false,CONTROL_INPUT,null,null);
        addPatientNode(formNode,modelNode,xformsNode,NODE_PATIENT_ID,DATA_TYPE_INT,"Patient ID","The patient ID",false,true,CONTROL_INPUT,null,null);

        addPatientNode(formNode,modelNode,xformsNode,NODE_GENDER,DATA_TYPE_TEXT,"Gender","The patient's sex",false,false,CONTROL_SELECT1,new String[]{"Male","Female"},new String[]{"M","F"});
        ...
        if(locations != null){
            ...
            addPatientNode(formNode,modelNode,xformsNode,NODE_LOCATION_ID,DATA_TYPE_INT,"Location","The patient's location",true,false,CONTROL_SELECT1,items,itemValues);
        }
        ...
        if(identifierTypes != null){
            ...
            addPatientNode(formNode,modelNode,xformsNode,"patient_identifier_type_id",DATA_TYPE_INT,"Identifier Type","The patient's identifier type",true,false,CONTROL_SELECT1,items,itemValues);
        }
