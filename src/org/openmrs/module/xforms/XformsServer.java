...
/**
 * Serves xform services to non HTTP connections.
 * Examples of such connections can be SMS, Bluetooth, Data cable, etc.
 * 
 * @author Daniel
 *
 */
public class XformsServer {
	...
	private String getActionUrl(){
		...
		return "http://" + serverIP + ":8080/openmrs" + XformConstants.XFORM_DATA_UPLOAD_RELATIVE_URL;
	}
