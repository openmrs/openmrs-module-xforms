...
public class DWRXformsService {
	...
	public void saveFormField(Integer fieldId, String name, Integer tabIndex, boolean isNew) {
		((XformsService) Context.getService(XformsService.class))
		        .saveMedicalHistoryField(new MedicalHistoryField(fieldId, name, tabIndex, isNew));
	}
	...
	public static TreeMap<Integer, TreeSet<MedicalHistoryField>> getMedicalHistoryFieldsStructure(
	        List<MedicalHistoryField> fields) {
	...
	private String generateJSTree(TreeMap<Integer, TreeSet<MedicalHistoryField>> formFields, Integer current,
	        Locale locale) {
		String s = "";
	...
	private String generateFormFieldJavascript(MedicalHistoryField field, Locale locale) {
		...
		return "addNode(tree, {fieldId: " + field.getFieldId() + ", " + "parent: " + parent + ", " + "fieldName: \""
		        + WebUtil.escapeQuotesAndNewlines(field.getName()) + "\", " + "isNew: " + field.isNew() + ", " + "tabIndex: "
		        + field.getTabIndex() + "});";
	}
